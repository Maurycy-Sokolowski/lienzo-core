...
public class ImageProxy<T extends AbstractImageShape<T>> implements ImageDataFilterable<ImageProxy<T>> {
	...
	/**
	 * Returns whether the image has been loaded and whether the selection layer
	 * image has been prepared (if needed.)
	 * 
	 * @return
	 */
	...
	/**
	 * Sets the {@link ImageShapeLoadedHandler} that will be notified when the
	 * image is loaded. If the image is already loaded, the handler will be
	 * invoked immediately.
	 * 
	 * @param handler
	 *            {@link ImageShapeLoadedHandler}
	 */
	 ...
	 * 
	 * @param mimeType
	 *            If null, defaults to DataURLType.PNG
	 * @return String
	 */
